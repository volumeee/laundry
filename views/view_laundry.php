...
<div class="content">
    ...
    <table border="1" style="width: 100%">
        ...
        <tr>
            ...
            <td>
                <a
                    href="<?php echo SITE_URL; ?>/laundry.php?action=delete&idtrans=<?php echo $_GET['idtrans'] ?>&iddetail=<?php echo $lan['iddetail']; ?>&idlaundry=<?php echo $lan['idlaundry'] ?>">Hapus</a>
